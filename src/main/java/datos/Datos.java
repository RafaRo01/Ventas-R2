...
//----------------Cod Citas-----------------
    ...
    public int getCitaEmpleadoID(){
        return citaEmpleadoID;
    }
    
    public void setCitaEmpleadoID(int citaEmpleadoID){
        this.citaEmpleadoID=citaEmpleadoID;
    }
